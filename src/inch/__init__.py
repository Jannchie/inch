...
class InchPoolExecutor:
    ...
    def __exit__(self, *_):
        ...
        console.print(
            f":white_check_mark: Finished in {self.finished_at - self.started_at}"
        )

    def start_inch(self, task: Inch):
    ...
    def __run_tasks(self):
        ...
        def run_task(task: Inch):
            ...
            self.__running_tasks = {
                k: v for k, v in self.__running_tasks.items() if v.completed != v.total
            }
